...
class TestFlashBootEntry():
    ...
    def test_EnterBootloader_InBootModeWithSerial(self, flash_tool, line_master):
        ...
        line_master.conditional_change_address.assert_called_with(0x12345678, 0x06, wait=True, timeout=1)
    ...
    def test_EnterBootloader_AppMode(self, flash_tool, line_master):
        ...
        line_master.conditional_change_address.assert_called_once_with(0x12345678, 0x06, wait=True, timeout=1)
